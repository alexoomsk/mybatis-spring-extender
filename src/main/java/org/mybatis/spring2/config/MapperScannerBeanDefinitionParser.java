 ...
 */
package org.mybatis.spring2.config;

import java.lang.annotation.Annotation;

import org.mybatis.spring2.mapper.MapperFactoryBean;
import org.mybatis.spring2.mapper.ClassPathMapperScanner;
  ...
  public synchronized BeanDefinition parse(Element element, ParserContext parserContext) {
    ...
    try {
      ...
      if (StringUtils.hasText(nameGeneratorClassName)) {
        ...
        BeanNameGenerator nameGenerator = (BeanNameGenerator)BeanUtils.instantiateClass(nameGeneratorClass);
